<template>
  <page-component :title="'nov.'">
    ...
    <div class="page__article">
      <img class="img-illu img-illu-left" src="@/assets/img/illus/november/nov_3.svg" alt="Illustration">
    ...
    <div class="page__article">
      <img class="img-illu img-illu-right img-illu-bigger" src="@/assets/img/illus/november/nov_4.svg" alt="Illustration">
