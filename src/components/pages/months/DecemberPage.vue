<template>
  <page-component :title="'dec.'">
    <div class="page__article">
      <img class="img-illu img-illu-left img-illu-bigger" src="@/assets/img/illus/december/dec_1.svg" alt="Illustration">
      <h2>Twitter makes it easier for developers to build chatbots on its platform</h2>
      <p>The company launched an enterprise API, and took Direct Message tools out of beta.</p>
      <p>In April of this year, the company unveiled its Account Activity API, essentially as a way to make it easier for developers to build applications on the Twitter platform, and, on Tuesday, Twitter announced that it is taking the API's Direct Message features out of beta.</p>
      <p>With this news, developers will now be able to build solutions with features that include quick replies, welcome messages, buttons on messages, custom profiles and Customer Feedback Cards. Developers will be able to edit their welcome messages, as well use read receipts to let customers know that their messages have been received.</p>
    ...
    <div class="page__article">
      ...
      <p>But a robot therapist could help people with mental health by Facebook Messenger.</p>
      <p>Researchers have shown that they have been shown to reduce symptoms of depression. Woebot uses artificial intelligence to create natural, personalised and human-like conversations and offers emotional support to users.</p>
    ...
    <div class="page__article">
      <img class="img-illu img-illu-left" src="@/assets/img/illus/december/dec_3.svg" alt="Illustration">
      ...
      <p>Ralph the giftbot has been created as a guide through the notoriously stacked back catalogue of Lego kits. He was built to give Lego an ecommerce foothold on the social network.</p>
      <p>The bot has been developed as a streamlined experience. Ralph the Robot asks users questions like their age, budget, and the type of sets they are interested in. A few seconds later and a slew of kits have been coughed up for purchase, complete with free shipping.</p>
    ...
    <div class="page__article">
      <img class="img-illu img-illu-right img-illu-bigger" src="@/assets/img/illus/december/dec_4.svg" alt="Illustration">
      <h2>Tha place of chatbots in advertising</h2>
